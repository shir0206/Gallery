...
Placeholder folder for gallery background and artwork images.

`src/api/artworkApi.ts` currently references image paths in this folder
(`gallery-background-placeholder.webp`, `artwork-placeholder-1.jpg`, etc.)
