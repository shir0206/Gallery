...
export function DetailsSection({ artwork, onAddToCart }: DetailsSectionProps) {
  ...
  const roomStyle = {
    ...
    "--room-mobile-image": `url("${
      isPortrait ? mobileRoomPortrait : mobileRoomLandscape
    }")`,
  } as CSSProperties;
  ...
  return (
    ...
    >
      ...
      <div className="acquisition-panel">
        ...
        <p className="overview-description acquisition-artwork-title">
          {artwork.title}
        </p>
          ...
          <div className="acquisition-offer">
            {offer && (
              <div className="acquisition-offer-top">
                <span className="acquisition-old-price">
            ...
            {canPurchase ? (
              ...
              <p className="acquisition-status">
      ...
      <p className="room-scale-note">
        Shown in a residential setting for scale and inspiration.
      </p>
    </section>
  );
}
